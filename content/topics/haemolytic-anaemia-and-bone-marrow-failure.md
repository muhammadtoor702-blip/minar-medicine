...
**The patient:** A 19-year-old man of West African origin. Severe pain in hands, feet, and chest. Hb 6.2 g/dL. Multiple similar episodes since childhood. Jaundiced. Palpable spleen. Blood film: sickle-shaped cells and target cells. Temperature 38.4°C. CXR: new bilateral infiltrates.

**Step 1 — Diagnose sickle cell disease and recognise acute chest syndrome:** The clinical picture is unmistakeable: West African origin + recurrent pain crises since childhood + jaundice + splenomegaly + sickle cells on blood film = **sickle cell disease (HbSS)**. But the danger here is not the vaso-occlusive crisis — it is what is happening in his chest. **Chest pain + fever + new bilateral infiltrates in a sickle cell patient = acute chest syndrome (ACS)**. This is the leading cause of death in SCD and must be recognised immediately. ACS can begin insidiously, disguised as a pain crisis.

**Step 2 — Assess severity of ACS — this is a medical emergency:** Check: SpO₂ (hypoxia = worsening), respiratory rate, work of breathing. ABG if SpO₂ is falling. ACS mortality is 3–9% per episode; patients can deteriorate rapidly to respiratory failure. This patient needs **HDU/ICU-level monitoring**. The combination of bilateral infiltrates + chest pain + fever + hypoxia in SCD = activate the ACS pathway immediately.

**Step 3 — Start ACS treatment urgently — do not treat this as a simple VOC:** ACS management differs fundamentally from vaso-occlusive crisis:
- **Antibiotics**: Ceftriaxone 2g IV daily + azithromycin 500mg OD (covers atypical organisms — *Mycoplasma*, *Chlamydophila* — which can precipitate ACS). Infection is a common trigger.
- **Exchange transfusion** (not simple top-up): Reduces HbS percentage to <30% while maintaining total Hb. Simple transfusion in severe ACS risks hyperviscosity. Urgent haematology input for exchange transfusion.
- **Oxygen**: Target SpO₂ ≥95% (unlike VOC where supplemental O₂ is not given unless SpO₂ <95% — in ACS, hypoxia drives further sickling in the pulmonary vasculature).
- **Bronchodilators**: Salbutamol nebulisers — airway hyperreactivity is common in SCD.
- **IV fluids and analgesia**: Maintain hydration (reduces sickling), IV morphine with PCA for pain.

**Step 4 — Simultaneously manage the underlying vaso-occlusive crisis:** While ACS is the priority, the pain crisis also requires: IV morphine titrated to effect (do not withhold opioids — SCD pain is severe); IV fluids (hydration reduces sickling by maintaining blood volume); warmth; treat infection with antibiotics; monitor for other complications (priapism, splenic sequestration, stroke — all vaso-occlusive phenomena).

**Step 5 — Long-term disease modification — start or review hydroxyurea:** This patient has had multiple episodes since childhood — he is a candidate for **hydroxyurea (hydroxycarbamide)** if not already on it. Hydroxyurea increases HbF production (HbF does not co-polymerise with HbS), reducing VOC frequency by ~50% and ACS incidence. It also reduces the need for transfusions. Offer to all patients with ≥3 painful crises per year. If ACS is severe and recurrent, consider **long-term exchange transfusion programme** (target HbS <30%). Screen for stroke with transcranial Doppler. Ensure lifelong penicillin V and vaccination are in place (pneumococcal, meningococcal, Hib — functional asplenia from autosplenectomy makes encapsulated organism sepsis a perpetual risk).

**Exam trigger:** *West African teenager + recurrent pain crises since childhood + sickle cells on film + chest pain + fever + bilateral CXR infiltrates* → **sickle cell disease + acute chest syndrome**. ACS is the leading cause of death — treat urgently with antibiotics (ceftriaxone + azithromycin), oxygen, and **exchange transfusion** (not simple transfusion). The distractor is treating this as a standard vaso-occlusive crisis and giving only analgesia and fluids — the bilateral infiltrates and fever signal ACS, which requires fundamentally different and more aggressive treatment. The other distractor: in aplastic crisis from parvovirus B19, the reticulocyte count is paradoxically LOW (unlike all other SCD complications where it is elevated).
