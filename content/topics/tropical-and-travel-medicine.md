...
**The patient:** A 28-year-old man with 4-day history of high-grade fever, rigors, myalgia, and headache. Returned from rural Kenya 3 days ago. No malaria prophylaxis. Temperature 39.6°C, HR 116, BP 104/68. Splenomegaly. Blood film: ring forms and banana-shaped gametocytes.

**Step 1 — The blood film is diagnostic — identify the species:** Ring forms (trophozoites within red cells) + **banana-shaped gametocytes** = ***Plasmodium falciparum*** — pathognomonic. The banana/crescent-shaped gametocyte is found only in *P. falciparum* — all other species produce round gametocytes. Rural Kenya is a high-transmission *falciparum* malaria zone. No prophylaxis = fully non-immune. This is confirmed falciparum malaria.

**Step 2 — Assess for severe malaria immediately — this is not a wait-and-see situation:** Check WHO criteria for severe falciparum malaria (any ONE triggers severe disease classification and ICU-level management): Consciousness? Seizures? Hb (anaemia <7 g/dL)? Creatinine (AKI)? Glucose (hypoglycaemia)? Parasitaemia level (>2% = severe)? Respiratory distress? Haemorrhage/DIC? This patient has BP 104/68 and HR 116 — haemodynamic compromise is present and may indicate incipient circulatory collapse. Even without meeting explicit WHO severe criteria, this patient requires urgent specialist infectious disease involvement and close monitoring.

**Step 3 — Treat uncomplicated falciparum with artemisinin-based combination therapy; escalate to IV artesunate if severe:** For **uncomplicated** *P. falciparum*: **artemether-lumefantrine (Riamet)** — first-line in the UK. Must be taken **with fatty food** (increases bioavailability by 4-fold). For **severe** malaria: **IV artesunate** — superior to IV quinine (AQUAMAT trial: reduced mortality by 22.5% in African children; SEAQUAMAT trial: adults in SE Asia). If IV artesunate is unavailable: IV quinine + doxycycline as an alternative. This patient's borderline haemodynamics require reassessment — if any WHO criteria are met, IV artesunate is mandatory. Admit to hospital regardless.

**Step 4 — Monitor blood glucose and repeat parasitaemia:** Falciparum malaria causes hypoglycaemia by two mechanisms: (1) parasite glucose consumption; (2) quinine (if used) stimulates pancreatic insulin secretion. Check blood glucose hourly during treatment — particularly if quinine is used. Repeat blood films every 12–24 hours to confirm parasitaemia is falling. A rising parasitaemia despite adequate treatment raises the possibility of artemisinin partial resistance (now emerging from Southeast Asia, though less common in Africa). Parasitaemia should fall by ≥75% at 72 hours.

**Step 5 — No primaquine needed for falciparum — but consider for relapsing species:** *P. falciparum* does NOT form hypnozoites (no dormant liver stage) — no primaquine required. If this were *P. vivax* or *P. ovale*, primaquine would be essential to prevent relapse from hypnozoites. Before giving primaquine: always check **G6PD status** — primaquine causes haemolytic anaemia in G6PD-deficient patients (X-linked; common in populations from Africa, the Mediterranean, and Southeast Asia — all overlapping with malaria-endemic regions).

**Step 6 — Contact tracing and reporting:** Malaria is a notifiable disease in the UK — report to the local Health Protection Unit. Advise the patient on mosquito precautions if they plan to return to endemic areas. Counsel that future trips require chemoprophylaxis: atovaquone-proguanil (Malarone) or doxycycline, starting before departure and continuing after return.

**Exam trigger:** *Returning traveller from sub-Saharan Africa + no prophylaxis + fever + splenomegaly + ring forms + banana-shaped gametocytes on blood film* → ***Plasmodium falciparum* malaria**. Banana-shaped gametocytes are pathognomonic of falciparum. No prophylaxis = no false reassurance of protection. **Three blood films 12–24 hours apart** if initial film negative — a single negative film does not exclude malaria. Severe malaria → IV artesunate (not IV quinine as first choice). *P. falciparum* does NOT relapse (no hypnozoites — no primaquine needed). The distractor is being reassured by "negative RDT" — RDTs detect falciparum HRP-2 but may miss low-level parasitaemia; always confirm with blood film. The other distractor is delaying treatment pending an admission blood result — in malaria, empirical treatment can be lifesaving when the clinical picture is convincing and film processing is delayed.
