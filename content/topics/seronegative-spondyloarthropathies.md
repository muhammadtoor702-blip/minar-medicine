...
**The patient:** A 26-year-old man with 3 years of low back pain and stiffness worst in the early morning, lasting over an hour, improving with exercise but not rest. He had an episode of left eye pain and redness last year. His father has a similar back condition. HLA-B27 positive. MRI sacroiliac joints: bilateral bone marrow oedema.

**Step 1 — Identify inflammatory back pain (not mechanical):** The morning stiffness lasting >1 hour and improvement with exercise (not rest) are the cardinal features of inflammatory back pain. Mechanical back pain improves with rest, worsens with activity. This distinction is the critical first step — most chronic low back pain is mechanical and never investigated further. The flags here are: age <45, morning stiffness >1 hour, improvement with movement, associated uveitis, and a family history. This is inflammatory until proven otherwise.

**Step 2 — Apply ASAS criteria — this is non-radiographic axial SpA, meeting criteria for ankylosing spondylitis:** ASAS imaging arm: MRI showing bilateral sacroiliac bone marrow oedema (= active sacroiliitis) is positive. Plus ≥1 SpA feature: HLA-B27 positive, anterior uveitis (left eye pain and redness), and family history. This patient meets the imaging arm of ASAS criteria easily. The diagnosis is **axial spondyloarthritis (ankylosing spondylitis)**. MRI is essential — plain X-ray is insensitive for early sacroiliitis; structural damage (erosions, sclerosis, ankylosis) appears years after inflammation begins.

**Step 3 — NSAIDs first-line — and a diagnostic clue:** Start a full-dose NSAID (naproxen 500mg BD or diclofenac 75mg BD). In ankylosing spondylitis, the response is characteristically dramatic — near-complete relief within 24–48 hours. This is different from the modest symptomatic benefit seen in mechanical back pain or OA. A patient whose back pain is "80% better" on full-dose naproxen has inflammatory back pain until proven otherwise. Continue NSAIDs continuously (not PRN) — continuous use slows radiographic progression. Pair with a gastric protectant (PPI or misoprostol). Refer to rheumatology.

**Step 4 — Physiotherapy is mandatory alongside NSAIDs:** Unlike RA (where rest protects inflamed joints), AS improves with sustained movement. Regular physiotherapy — targeting spinal extension, breathing exercises, and hip mobility — preserves posture and lung function. Without physiotherapy, progressive ankylosis leads to a fixed kyphotic spine and restricted chest expansion. This is lifelong, not a course of treatment.

**Step 5 — Anti-TNF or anti-IL-17 if response is inadequate:** If BASDAI ≥4 (active disease) after adequate trials of at least 2 NSAIDs (6 weeks each) → escalate to biologic therapy. Options: **anti-TNF** (adalimumab, etanercept, infliximab, certolizumab) or **anti-IL-17** (secukinumab, ixekizumab). Conventional DMARDs (methotrexate, sulfasalazine) do NOT work for axial disease — do not prescribe them for spinal symptoms. Sulfasalazine can be used if there is peripheral joint involvement. This patient's uveitis history is relevant: anti-TNF agents reduce uveitis flares; IL-17 inhibitors do not, and are avoided in patients with concomitant IBD.

**Exam trigger:** *Inflammatory back pain (<45 years) + morning stiffness >1 hour + improvement with exercise + anterior uveitis + HLA-B27 + bilateral sacroiliac bone marrow oedema on MRI* → ankylosing spondylitis. Use **MRI** (not X-ray) for early diagnosis. **NSAIDs first-line** (dramatically effective — near-complete relief within 48 hours, which is itself diagnostically informative). Conventional DMARDs do NOT work for axial disease. The distractor is prescribing methotrexate for the spinal symptoms (wrong — only works peripherally) or using plain X-ray as the initial investigation (too insensitive to detect early sacroiliitis).
