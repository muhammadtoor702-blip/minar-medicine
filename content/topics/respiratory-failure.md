...
```mermaid
flowchart TD
    A["Respiratory Failure: dyspnoea, cough, chest pain, hypoxaemia, or imaging abnormality"] --> B["Immediate severity: SpO2, RR, work of breathing, ABG/VBG, CXR/CT when indicated"]
