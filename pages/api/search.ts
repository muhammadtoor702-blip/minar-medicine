...
const TOPIC_SLUGS = [
  ...
  'cns-infections', 'dementia', 'epilepsy-and-seizures', 'headache',
  'movement-disorders', 'multiple-sclerosis', 'neuromuscular-disease',
  'stroke-and-tia',
  'adrenal-disease', 'diabetes-mellitus', 'pituitary-and-calcium',
  'reproductive-endocrinology', 'thyroid-disease',
  'anaemia', 'bleeding-disorders-and-thrombosis', 'haematological-malignancies',
  ...
  'antimicrobial-stewardship', 'fever-and-immunocompromised', 'hiv-and-aids',
